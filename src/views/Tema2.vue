      ...
      .col-lg-10
        .row
          .col-lg-7.mb-4
            ...
            p El dominio corresponde al segundo elemento clave al momento de publicar una aplicación o servicio web, y se trata de un nombre único mediante el cual todos los servicios web podrán ser localizados en Internet. Al trabajar en la red, todos los elementos tienen una dirección por medio de la cual pueden ser ubicados, esta dirección corresponde a un conjunto de números y se le conoce con el nombre de dirección IP.
